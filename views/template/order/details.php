...
<?php
    ...
    if($order->files || $order->newFiles){ ?>
        <h3>Document Download</h3>
            <p>Please select download on the appropriate files you wish to store. Documents will be saved here so you can come back anytime to retrieve them.</p>
            <table class="table table-striped">
                <thead>
                <tr>
    ...
    <?php }else{ ?>
        <p>Documents are not yet available for this order. Click here to receive an email when the documents are available.</p>
