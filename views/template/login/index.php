...
------------------------------------------------------------------------------------------------------
xx/xx/xx	Created											andy.Simpson	Created by PhpStorm
04/10/17	last_edited									andy.simpson	Last Save date on server
09/04/18	tidy												neil.Baker		Changed link to reset password so it is more informative
17/01/19  placeholder                 Neil.Baker    Change placeholder on username field to make it obvious that email is required
------------------------------------------------------------------------------------------------------*/

// Comment left by Andy.Simpson
...
<div class="row">
    <form class="form-signin">
        ...
        <input type="email" id="username" class="form-control" placeholder="Enter your Email address" required autofocus>
        <label for="password" class="sr-only">Password</label>
        <input type="password" id="password" class="form-control" placeholder="Password" required>
        <button class="btn btn-lg btn-primary btn-block" id="login">Sign in</button>
        <a class="btn btn-sm btn-link" id="forgot" data-toggle="modal" data-target="#forgotModal">Forgotten / Change Password</a>
    </form>
</div>
